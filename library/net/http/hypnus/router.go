...
func (r *Router) GET(path string, handles ...HandlerFunc) {
	r.Handle("GET", path, handles...)
}

// HEAD is a shortcut for router.Handle("HEAD", path, handle)
func (r *Router) HEAD(path string, handles ...HandlerFunc) {
	r.Handle("HEAD", path, handles...)
}

// OPTIONS is a shortcut for router.Handle("OPTIONS", path, handle)
func (r *Router) OPTIONS(path string, handles ...HandlerFunc) {
	r.Handle("OPTIONS", path, handles...)
}

// POST is a shortcut for router.Handle("POST", path, handle)
func (r *Router) POST(path string, handles ...HandlerFunc) {
	r.Handle("POST", path, handles...)
}

// PUT is a shortcut for router.Handle("PUT", path, handle)
func (r *Router) PUT(path string, handles ...HandlerFunc) {
	r.Handle("PUT", path, handles...)
}

// PATCH is a shortcut for router.Handle("PATCH", path, handle)
func (r *Router) PATCH(path string, handles ...HandlerFunc) {
	r.Handle("PATCH", path, handles...)
}

// DELETE is a shortcut for router.Handle("DELETE", path, handle)
func (r *Router) DELETE(path string, handles ...HandlerFunc) {
...
func (r *Router) Handle(method, path string, handles ...HandlerFunc) {
	if path[0] != '/' {
