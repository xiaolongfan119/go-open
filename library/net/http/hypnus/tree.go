...
func (n *node) insertChild(numParams uint8, path, fullPath string, handles ...HandlerFunc) {
...
// given path.
func (n *node) getValue(path string) (handles []HandlerFunc, p Params, tsr bool) {
